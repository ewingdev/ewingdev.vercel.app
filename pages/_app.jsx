        ...
        <div style={{ zIndex: 99999 }} className="fixed bg-black/50 w-full h-screen flex justify-center items-center pointer-events-none">
            <div className="flex items-center gap-x-6 animate-pulse">
                <div className="text-center">
                    <p className="text-6xl mb-5 font-semibold">ewingdev</p>
      ...
      <div className="bg-[#191932]/10">
        <div className="max-w-screen-lg p-5 w-full md:w-10/12 lg:w-8/12 mx-auto transition-all duration-300">
          <div className="md:flex w-full items-center justify-between">
            <div>
              <p>Copyright &copy; 2022 - Developed with ❤️ by ewingdev.</p>
              <a href="https://github.com/ewingdev/ewingdev.vercel.app" target="_blank" rel="noreferrer" className="hover:text-red-500 transition-all duration-200">This website is open source on GitHub.</a>
            </div>
            <div className="mt-2 md:mt-0 flex items-center">
              <a href="https://discord.com/users/774591026940739585" target="_blank" rel="noreferrer" className="w-full md:w-auto rounded-lg bg-[#191932]/20 p-2 px-6 hover:bg-[#191932]/30 shadow-lg shadow-white/0 hover:shadow-3xl hover:shadow-[#191932]/20 transition-all duration-200">
