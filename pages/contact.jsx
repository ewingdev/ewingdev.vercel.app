      ...
      <div className="py-20">
        ...
        <div className=" flex justify-center flex-col items-center">
            <div className="max-w-lg w-full">
                ...
                <a target="_blank" rel="norefferer" href="https://twitter.com/ewingbaba">
                ...
                <a target="_blank" rel="norefferer" href="https://discord.com/users/774591026940739585">
                    <div className="mt-2 flex justify-between bg-[#191932]/20 hover:bg-[#191932]/30 transition-all duration-200 px-4 py-2 rounded-lg items-center">
                        <i className="fab fa-discord fa-2x" />
                        <p className="font-semibold text-xl">éwing#2319</p>
                    </div>
                </a>
                <a href="mailto:wyksiw@gmail.com">
                    <div className="mt-2 flex justify-between bg-[#191932]/20 hover:bg-[#191932]/30 transition-all duration-200 px-4 py-2 rounded-lg items-center">
                        <i className="fa fa-envelope fa-2x" />
                        <p className="font-semibold text-xl">wyksiw@gmail.com</p>
                    </div>
                </a>
            </div>
        </div>
